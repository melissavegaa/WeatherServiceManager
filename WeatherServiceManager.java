...
public class WeatherServiceManager{
    ...
    public void callWeatherWebService(String sCity){
        ...
        // Turn raw json into java object hierarchy using Google's gson.
    ...
    public static void main(String[] args){
        ...
        WeatherServiceManager manager1 = new WeatherServiceManager();
        WeatherServiceManager manager2 = new WeatherServiceManager();
        ...
        manager1.callWeatherWebService(sCity1);
        manager2.callWeatherWebService(sCity2);
        ...
        if(manager1.getCurrentTemp() > manager2.getCurrentTemp()) {
            System.out.println("The city with the highest current temperature is " + manager1.m_oWeather.name);
        }
        else {
            System.out.println("The city with the highest current temperature is " + manager2.m_oWeather.name);
        }
        float rangeManager = (manager1.getHighTemp() - manager1.getLowTemp());
        float rangeCity = (manager2.getHighTemp() - manager2.getLowTemp());

        if(rangeManager > rangeCity) {
            System.out.println("The city with the greatest range between low and high is " + manager1.m_oWeather.name);
        }
        else {
            System.out.println("The city with the greatest range between low and high is " + manager2.m_oWeather.name);
        }
        // ###### END: YOUR CODE HERE ######
    }
}
